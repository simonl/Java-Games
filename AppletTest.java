...
public class AppletTest {
	...
	//CircularLayout layout = new CircularLayout(balls);
	...
	//PointerProjectile controller = new PointerProjectile(player.motion);
	ElasticDragger controller = new ElasticDragger(player.motion, 0.1);
