...
public class WindowMomentumBox extends JFrame
{
	public PanneauMomentumBox panel = new PanneauMomentumBox();
	...
	public WindowMomentumBox(String s, int limitU, int limitD)
	{
	    this.setTitle(s);
