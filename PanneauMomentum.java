...
public class PanneauMomentum extends JPanel
{
	...
	public int num, limitU = 840, limitD = 0, zFocus = 150, realU, realD;
	...
	public void paintComponent(Graphics g){
		...
		for(int i = 50; i <= 700; i = i + 25)
		{
			...
			g2d.drawLine(0, 840, (limitU - box) / 2, (limitU - box) / 2 + box);
			g2d.drawLine(840 , 0, (limitU - box) / 2 + box, (limitU - box) / 2);
			g2d.drawLine(840, 840, (limitU - box) / 2 + box, (limitU - box) / 2 + box);
		    }
		}
