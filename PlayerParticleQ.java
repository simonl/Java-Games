...
public class PlayerParticleQ extends ParticleQ
{
    ...
    //CONSTRUCTORS
    public PlayerParticleQ() throws Exception
    {
    ...
    public PlayerParticleQ(Quantity mass) throws Exception
    {
	this(mass, new Quantity(0.0, Units.CHARGE), new MotionQ());
    }
    
    public PlayerParticleQ(Quantity mass, Quantity charge) throws Exception
    {
	this(mass, charge, new MotionQ());
    }
    
    public PlayerParticleQ(Quantity mass, Quantity charge, MotionQ mQ) throws Exception
    {
	this();
    ...
    public PlayerParticleQ(Quantity mass, MotionQ mQ) throws Exception
    {
	this(mass, new Quantity(0.0, Units.CHARGE), mQ);
    }
    
    public PlayerParticleQ(ParticleQ pQ) throws Exception
    {
	...
	Quantity multU2 = (new Quantity(2)).times(m2).times(multV1).minus(multU1.times(m2.minus(m1))).div(m1.plus(m2)); //(P-P)M = SPEED
